...
$Author: joetan54 $
$URL: https://wordpress-reports.googlecode.com/svn/trunk/tantan-reports/wordpress-reports/lib.googleanalytics.php $
*/
...
class tantan_GoogleAnalytics {
    ...
    function login($user, $passwd) {
        ...
        */
        ...
        $this->req->addPostData('continue', 'https://www.google.com/analytics/settings/?&et=reset&hl=en-US');
		...
		for($i=0; $i<count($lines); $i++) if ($lines[$i] != '') {
            ...
            if (!$reportMeta) {
                ...
                if (!$currentSection) {
                    ...
                    //
                    // this section might not be useful anymore
